...
exemplo, estudamos especificamente o módulo de prosódia. % Futuramente, avanços
...
\citeonline{tts-book} propõe uma arquitetura geral, dividindo os sistemas em duas partes principais:
