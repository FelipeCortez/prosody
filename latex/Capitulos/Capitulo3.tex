...
\citeonline{costa} para funcionar de maneira \emph{stand-alone}, isto é, ser utilizado
...
glote -- como visto na seção \ref{formant} -- quando falamos.
...
subsequentes como \cite{intsintalg,stoc} utilizaram a notação para sintetizar
