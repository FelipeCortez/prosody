...
linguagem unificada. A linguagem foi adotada pelo MaryTTS, além dos sistemas proprietários Alexa, Google Assistant e Cortana. A especificação é mantida pela W3C \cite{ssml}.
A especificação cita os elementos \emph{emphasis},
...
português brasileiro em diversos trabalhos, \citeonline{lucente} argumenta que
