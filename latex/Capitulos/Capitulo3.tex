...
Cada voz gravada fornece uma tabela com os dífonos que podem ser utilizados. Utilizamos neste trabalho a voz \code{br3} desenvolvida por Denis R. Costa disponível no site oficial do projeto MBROLA.
% referência?
...
Utilizada por \citeonline{moraes2008} para analisar uma mesma frase com
...
subsequentes como \cite{intsintalg,stoc} utilizaram a mesma notação para sintetizar
...
um novo modelo, DaTo, com base na entoação do português brasileiro.
